...
const GOALS: Goal[] = [
  {
    ...
    steps: [
      ...
      { n: "03", title: "Подать заявку онлайн", desc: "Заполните короткую форму, подпишите ЭЦП и получите номер заявки.", cta: "Оформить заявку", href: "/services/akk-animal/apply" },
    ],
  },
  {
    id: "finance",

      ...
      <Tabs defaultValue="card" className="mt-6">
        ...
        <TabsContent value="form" className="pt-6">
          <div className="mb-3 rounded-control border border-border bg-bg px-4 py-2.5 text-[13px] text-muted">
            Бизнес-режим позволяет добавлять готовые блоки, собирать условия
            И/ИЛИ и формулы списками без ручного синтаксиса. Изменения
            автосохраняются новой версией; перед публикацией сервер блокирует
            битые ссылки, дубли полей и некорректные расчёты.
          </div>
          <FormConstructor

...
SERVICES: list[dict] = [
    # 1. АКК — животноводство (flagship: реальные цифры, ветвление, формула, 70%)
    {
        "create": {"title": "Агробизнес: льготное кредитование животноводства", "orgId": "akk", "category": "credit", "slug": "akk-animal"},
        "card": {
            "summary": "Кредит на развитие животноводства по ставке 5% с требованием направить не менее 70% суммы на приобретение скота.",
            "description": "Программа Аграрной кредитной корпорации для микро-, малого и среднего бизнеса в животноводстве. Ставка 5% годовых, сумма до 1,5 млрд ₸, срок до 84 месяцев. Не менее 70% суммы займа направляется на приобретение скота.",
            "category": "credit",
            "reviewDays": 5,
            "conditions": [
                {"label": "Ставка", "value": "5%"},
                {"label": "Сумма", "value": "до 1,5 млрд ₸"},
                {"label": "На скот", "value": "не менее 70%"},
                {"label": "Срок", "value": "до 84 мес"},
            ],
            "documents": [
                {"name": "Справка о государственной регистрации", "auto": True},
                {"name": "Справка об отсутствии налоговой задолженности", "auto": True},
                {"name": "Бизнес-план проекта", "auto": False},
                {"name": "Устав (для ТОО)", "auto": False, "condition": "TOO"},
                {"name": "Договор на приобретение скота", "auto": False},
            ],
            "eligibility": {
                "questions": [
            ...
            "faq": [
                {"q": "Можно ли направить часть суммы на корма?", "a": "Да, но не более 30% — не менее 70% идёт на приобретение скота."},
                {"q": "Какой минимальный срок?", "a": "От 12 месяцев, максимальный — 84 месяца."},
            ],
            ...
            "docTemplate": (
                ...
                "просит предоставить льготный кредит на развитие животноводства\n"
                "в сумме {{answers.loan_amount}} ₸ сроком на {{answers.loan_term}} мес.\n\n"
                "На приобретение скота направляется {{answers.cattle_amount}} ₸.\n"
                "Ожидаемая экономия на ставке за срок кредита: {{calc.saving}} ₸."
            ),
        },
        "schema": {
            ...
            "pages": [
                company_page(),
                {
                    ...
                    "elements": [
                        {"type": "radiogroup", "name": "project_goal", "title": "Цель финансирования", "isRequired": True,
                         "choices": [{"value": "working", "text": "Пополнение оборотных средств"}, {"value": "investment", "text": "Инвестиции в основные средства"}]},
                        {"type": "number", "name": "loan_amount", "title": "Сумма займа, ₸", "isRequired": True, "min": 3000000, "max": 1500000000},
                        {"type": "number", "name": "loan_term", "title": "Срок займа, мес", "isRequired": True, "min": 12, "max": 84, "defaultValue": 60},
                        {"type": "number", "name": "own_share", "title": "Собственное участие, %", "min": 20, "max": 100,
                         "visibleIf": "{project_goal} = 'investment'",
                         "description": "Для инвестиционных целей — не менее 20%"},
                    ],
                },
                {
                    "name": "cattle",
                ...
                {
                    "name": "extended",
                    "title": "Этап 2 · Расширенные данные и документы",
                    "stage": 2,
